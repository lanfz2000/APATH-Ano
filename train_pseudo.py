...
import shutil
import copy
from model.plip_fc import PLIP_fc, get_plip_fc_lora, PLIP_fc_frozen, print_trainable_parameters
import random
import pandas as pd
...
def main():
    ...
    # load model
    model = get_plip_fc_lora().cuda()
    print_trainable_parameters(model)
 
    # load dataset
    train_all_root = '/home/ubuntu/data/lanfz/datasets/RINGS/train-100-patch/'
    train_data_root = '/home/ubuntu/data/lanfz/codes/adapater_weakly/pseudo_data/ODP_labels.csv'
    # train_data_root = '/home/ubuntu/data/lanfz/codes/adapater_weakly/pseudo_data/plip_0.5.csv'
